...
- `crates/marrow-check/src/checks.rs` - status: in-lane; owner: L06 checker-core; notes: schema diagnostic, duplicate-root, duplicate-declaration, duplicate-module, module-path, rejected-surface, enum, private-enum, duplicate-named-argument, append-target, conversion-source, and interpolation-source payload work integrated, including suppression matches in this file; broader checker-core review remains.
...
- `crates/marrow-check/tests/project.rs` - status: in-lane; owner: L06 checker-core; notes: early schema-family, duplicate-root, duplicate-declaration, duplicate-module, module-path, rejected-surface, schema unsupported-map, enum/member-path, parent-not-category, script-import, private-enum, duplicate-named-argument, append-target, conversion-source, and interpolation-source assertions now use exact diagnostic payloads for the integrated slices; broader checker-core test cleanup remains.
