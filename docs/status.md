...
Ordinary enum composition, local source reuse, additive updates and complete
recovery/backup/restore still require work. Broader future features are not
prerequisites.
