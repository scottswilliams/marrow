...
| P7 | Runtime error model and numerics | 6 | No | `literal-escape-decode` if temporal conversions overlap | `algo-compound-interest-decimal#0`, `algo-compound-interest-decimal#4`, `algo-date-daycount-leap#0`, `app-url-shortener#2`, `cluster-clock-duration#4`, `cluster-numerics-decimal#0` |
...
| P13 | Data CLI, serve protocol, locks | 3 | No | `saved-walk-cursor`, `cli-doc-migration`, `lsp-retire-inrepo` | `cluster-serve#0`, `cluster-serve#1`, `cluster-transactions-locks#1` |

Open issue count: 122.
