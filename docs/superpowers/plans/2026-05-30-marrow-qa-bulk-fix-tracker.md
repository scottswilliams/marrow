...
|---|---|---:|---|---|---|
| P1 | Parser, formatter, CLI, diagnostics | 6 | Maybe | `feat-defaults`, `cli-doc-migration`, `lsp-check-diagnostics`, `lsp-retire-inrepo`, `enum-binding-index`, `enum-segment-precision` | `algo-collatz#3`, `algo-sieve-primes#1`, `app-library-catalog#6`, `app-versioned-cms#6`, `cluster-modules-params#3`, `app-versioned-cms#4` |
