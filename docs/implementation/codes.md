...
class, catchability, lifecycle, and documented meaning. A `Reserved` lifecycle
documents a future contract: it drives the reference's reserved-codes section, and
a tidy gate proves no production emit site names the code until it flips to
`Active`.
