//! The container header layout a forged-image test must know: where the image digest sits,
//! and which bytes it covers.
//!
...
//! offset, which is the container format itself.
