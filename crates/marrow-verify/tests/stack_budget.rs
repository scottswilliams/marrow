...
//! | walk | bound | depth |
//! |---|---|---|
//! | `durable::decode_value_shape` | `MAX_DURABLE_VALUE_DEPTH` | 32 |
//! | `durable::value_shape_matches` | the shape that decode admitted | 32 |
//! | `durable::seal_branch_run` | `MAX_DURABLE_DEPTH` | 16 |
//!
