...
pub use diagnostics::{
    ...
    CHECK_RANGE, CHECK_RANGE_VALUE, CHECK_RECURSIVE_KEYED_ENTRY, CHECK_REJECTED_SURFACE,
    CHECK_RETURN_TYPE, CHECK_RETURN_VALUE, CHECK_STRING_ESCAPE, CHECK_THROW_TYPE,
    CHECK_TRY_HANDLER, CHECK_UNKNOWN_ENUM_MEMBER, CHECK_UNKNOWN_TYPE, CHECK_UNRESOLVED_CALL,
