...
pub use diagnostics::{
    ...
    CHECK_IS_TYPE, CHECK_KEY_TYPE, CHECK_LITERAL_RANGE, CHECK_LOSSY_ROUND_TRIP,
    CHECK_MATCH_REQUIRES_ENUM, CHECK_MISSING_RETURN, CHECK_MODULE_PATH, CHECK_MULTIPLE_SCRIPTS,
    CHECK_NEIGHBOR_UNSUPPORTED, CHECK_NEXT_ID_COLLISION, CHECK_NEXT_ID_REQUIRES_SINGLE_INT,
