use marrow_syntax::{Argument, Block, Expression, InterpolationPart, Severity, Statement};

use super::calls::{is_append_call, is_attached_data_call, is_exists_call, is_neighbor_read};
use super::effects::{
    call_writes_saved_data, condition_narrowings, invalidate_key_bindings,
    invalidate_removed_narrowings, invalidate_saved_narrowings, invalidate_written_target,
    mutating_arg_bindings, traversal_narrowing,
};
