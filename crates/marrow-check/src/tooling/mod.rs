...
pub use completion::{
    ...
    SourceNamespaceResourceCompletion, SourceTypeBuiltin, SourceTypeCompletionCandidate,
    SourceTypeCompletionFact, source_namespace_completion_fact,
    source_namespace_completion_file_fact, source_type_completion_fact,
};
pub use data::{
...
pub use hover::{
    ...
    SourceModulePathDefinitionFact, SourceModulePathHoverFact, SourceProjectModuleHoverFact,
    ...
    SourceStandardLibraryCapability, SourceStandardLibraryModuleHoverFact,
    SourceStandardLibraryNamespaceHoverFact, SourceStandardLibraryOperationHoverFact,
    SourceSymbolDocs, StoreRootHoverFact, StoreRootHoverMember, StoreRootHoverPathSegment,
    saved_place_hover_fact_at, source_callable_hover_fact_at,
    source_module_path_definition_fact_at, source_module_path_hover_fact_at,
    source_schema_hover_fact_at, source_symbol_docs_at, store_root_hover_fact_at,
};
pub use integrity::{
