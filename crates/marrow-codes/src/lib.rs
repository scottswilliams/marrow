...
codes! {
    ...
    CliCommandUnsupported => r#"cli.command_unsupported"#, Cli, Active, r#"The command name is reserved and not implemented: `data`, `evolve`, `serve`, `backup`, and `restore`. `marrow --help` lists the implemented commands."#;
