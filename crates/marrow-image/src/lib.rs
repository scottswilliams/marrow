...
pub use instr::{
    ...
    OP_DUR_SET_SPARSE, OP_EQ_BOOL, OP_EQ_BYTES, OP_EQ_INT, OP_EQ_TEXT, OP_FIELD_GET, OP_INT_ADD,
    ...
    OP_TEXT_GT, OP_TEXT_IS_EMPTY, OP_TEXT_LE, OP_TEXT_LT, OP_TEXT_TRIM, OP_TXN_BEGIN,
