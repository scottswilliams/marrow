...
pub use instr::{
    ...
    OP_DUR_READ_GROUP_PRESENT, OP_DUR_REPLACE_ENTRY, OP_DUR_REPLACE_GROUP, OP_DUR_SET_FIELD,
    ...
    OP_MAP_NEW, OP_MAP_REMOVE, OP_MAP_VALUE_AT, OP_POP, OP_RANGE_GUARD, OP_RECORD_NEW, OP_RETURN,
    OP_SOME_WRAP, OP_TEXT_CONCAT, OP_TEXT_CONTAINS, OP_TEXT_GE, OP_TEXT_GT, OP_TEXT_IS_EMPTY,
    OP_TEXT_JOIN, OP_TEXT_LE, OP_TEXT_LINES, OP_TEXT_LT, OP_TEXT_SPLIT, OP_TEXT_TRIM, OP_TODO,
    OP_TXN_BEGIN, OP_TXN_COMMIT, OP_UNREACHABLE, OP_VACANT_LOAD,
};
pub use interface::{
...
pub use value_dag::{
    CanonicalValueShapeDag, ValueShapeEnumMember, ValueShapeNodeId, ValueShapeView,
};
