...
const TABLE: &[StdOp] = &[
    ...
    row("text", "urlEncode", &[Scalar(Str)], scalar(Str), Always, None),
    row("text", "urlDecode", &[Scalar(Str)], scalar(Str), Always, None),
    ...
    row("bytes", "fromText", &[Scalar(Str)], scalar(Bytes), Always, None),
    row("bytes", "toText", &[Scalar(Bytes)], scalar(Str), Always, None),
    row("bytes", "hexEncode", &[Scalar(Bytes)], scalar(Str), Always, None),
    row("bytes", "hexDecode", &[Scalar(Str)], scalar(Bytes), Always, None),
    row("hash", "sha256", &[Scalar(Bytes)], scalar(Bytes), Always, None),
    row("hash", "sha512", &[Scalar(Bytes)], scalar(Bytes), Always, None),
    row("hash", "hmacSha256", &[Scalar(Bytes), Scalar(Bytes)], scalar(Bytes), Always, None),
    ...
    row("json", "stringLit", &[Scalar(Str)], scalar(Str), Always, None),
    row("json", "stringArray", &[SequenceArg(Str)], scalar(Str), Always, None),
    ...
    row("csv", "row", &[SequenceArg(Str)], scalar(Str), Always, None),
    ...
    row("clock", "addDays", &[Scalar(Date), Scalar(Int)], scalar(Date), Always, None),
    row("clock", "daysBetween", &[Scalar(Date), Scalar(Date)], scalar(Int), Always, None),
    row("clock", "year", &[Scalar(Date)], scalar(Int), Always, None),
    row("clock", "month", &[Scalar(Date)], scalar(Int), Always, None),
    row("clock", "day", &[Scalar(Date)], scalar(Int), Always, None),
