...
clock has and has not measured. Speed is a constraint here, not a claim: the
first clock has no end-to-end baseline, so do not write that Marrow compiles or
tests fast in public documentation, and give any figure the revision and method
